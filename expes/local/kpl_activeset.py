...
regus12 = torch.logspace(-8, 1, 100)
regus = torch.logspace(-8, -3, 100)
...
ax[0].plot(regus12, scs12_mean)
ax[0].set_xscale("log")
ax[0].set_yscale("log")
ax[0].set_ylabel("NMSE")
ax[1].plot(regus12, recos12_mean)
ax[1].set_xscale("log")
ax[1].set_ylabel("# Non-essential atoms")
ax[1].set_xlabel("$\\lambda$")
ax[0].hlines(scs_mean, xmin = regus12.min(), xmax = regus12.max(), linestyle="dashed", color="k", label="Best (true dictionary)")
ax[0].legend()
plt.show()